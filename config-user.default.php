...
return array (
	...
	'sort_order' => 'DESC',
	'sort' => 'date',	// { id => received date, date => publication date, link, title, rand }
	'anon_access' => false,
	'mark_when' => array (
		'article' => true,
		'gone' => false,
		...
		'same_link_read' => false,  // Mark as read if link matches an already-read entry (across all feeds)
		'scroll' => false,
		'focus' => false,
		'site' => true,
	),
