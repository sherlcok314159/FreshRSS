...
return array(
	...
	'menu' => array(
		...
		'search_short' => 'Search',
		'sort' => 'Sort by',
		'sort_date_asc' => 'Publication date (oldest first)',
		'sort_date_desc' => 'Publication date (newest first)',
		'sort_id_asc' => 'Received date (oldest first)',
		'sort_id_desc' => 'Received date (newest first)',
		'sort_link_asc' => 'Link (A-Z)',
		'sort_link_desc' => 'Link (Z-A)',
		'sort_rand' => 'Random',
